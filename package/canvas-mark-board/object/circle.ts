...
import { getDistance, getMinDistance, getUUID } from "../utils";
...
export default class MarkCircleObject extends MarkObject {
  ...
  boxMousemove() {
    ...
    if (
      ...
      if (this.acctivePointIndex == -1 || this.acctivePointIndex == 0) {
        // 更新点位
  ...
  /** 导入 */
  static import(box: CanvasMarkBoard, data: IMarkObjectJSON): MarkCircleObject {
